  ...
  return (
    <section className="request-container">
      <Row className="d-flex justify-content-between">
        ...
        <Col lg={5} md={6} className="box-hide-992">
          ...
          <div className="quote-form-title">
            <Row>
              <Col lg={6} md={12}>
                <h3>
                  Describe your{" "}
                  <span className="blue-highlight-text">plumbing</span>{" "}
                  requirement to get a quote
                </h3>
              </Col>
              <Col lg={3} md={12}>
                <h5 className="d-flex align-items-center">
                  <img src={lock} alt="Lock" /> Your information is 100% safe
                  and secure
                </h5>
              </Col>
              <Col lg={3} md={12}>
                <h5 className="d-flex align-items-center">
                  <img src={lock} alt="Lock" /> You will receive a response
                  within minutes
                </h5>
              </Col>
            </Row>
