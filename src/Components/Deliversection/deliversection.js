...
export const Deliversection = () => {
  return (
    <section className="deliver-section-container">
      <div className="deliver-banner-max-1900-show">
        <div className="d-flex justify-content-center">
          <img className="img-fluid" src={plumber2} alt="Plumber 2" />
        </div>
        <Row className="justify-content-center me-auto">
        <Col lg={9}>
          <div className="deliver-section-right-container">
            <div className="deliver-section-title text-center mb-5">
              <h1>What we deliver</h1>
            </div>
            <div className="deliver-section-description text-center">
              <p>
            ...
            <div className="deliver-section-card d-flex flex-wrap justify-content-center mt-5">
      ...
      <Row className="deliver-banner-min-1900-show">
        <Col lg={6}>
          <div className="deliver-section-right-container">
